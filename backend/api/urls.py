...
urlpatterns = [
    path('account/stream-key/', views.AccountStreamKeyView.as_view(), name='account-stream-key-detail'),
    path('account/stream-key/rotate/', views.AccountStreamKeyRotateView.as_view(), name='account-stream-key-rotate'),
    ...
    path('videos/<int:id>/stream-session/', views.VideoStreamSessionView.as_view(), name='video-stream-session-detail'),
